...
export function LifeHome({ profile, onChange, onViewReport, onClear }: {
  ...
  return <section className="life-home">
    ...
    <div className="life-content">
      <section className="daily-oracle-strip daily-oracle-strip--home" aria-label="每日灵感入口"><button type="button" onClick={onViewReport}><span>抽签</span><small>摇一支今日行动签</small></button><button type="button" onClick={onViewReport}><span>奇门</span><small>看当下先开哪扇门</small></button></section>
      {section === "record" && <>
