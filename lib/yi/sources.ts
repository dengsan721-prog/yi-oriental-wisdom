...
export const YI_RULE_SOURCES: Record<string, RuleSource> = {
  ...
  "relation.gan-zhi.v1": { ruleId: "relation.gan-zhi.v1", label: "干支关系完整规则表", appliesWhen: "五合、六合、六冲、刑、害、破需相关两柱均已知；三合需至少三支已知", sourceType: "classical-framework", version: "1.1.0", references: ["天干五合表：甲己、乙庚、丙辛、丁壬、戊癸", "地支六合表：子丑、寅亥、卯戌、辰酉、巳申、午未", "地支三合表：申子辰水局、亥卯未木局、寅午戌火局、巳酉丑金局", "地支六冲表：子午、丑未、寅申、卯酉、辰戌、巳亥", "地支相刑规则：子卯相刑；寅巳申三刑；丑戌未三刑；辰午酉亥自刑", "地支六害表：子未、丑午、寅巳、卯辰、申亥、酉戌", "地支六破表：子酉、卯午、辰丑、戌未、寅亥、巳申"] },
